<template>
    <div class="prose dark:prose-invert py-10">
        ...
        <p>Justin Mankowski</p>
        <p>
            <b>Kontakt:</b>
        </p>
        <p>E-Mail (Support &amp; Allgemeines): support@smashmc.eu<br></p>
        <p>
        ...
        <ul class="m-elements">
            ...
            <li>
                ...
                und Service, Kontaktanfragen und Kommunikation,
        ...
        <ul class="m-elements">
            <li>
                <strong>PayPal:</strong> Zahlungsdienstleistungen und -Lösungen
                (z.B. PayPal, PayPal Plus, Braintree); Dienstanbieter: PayPal
                (Europe) S.à r.l. et Cie, S.C.A., 22-24 Boulevard Royal, L-2449
                Luxembourg; Website:
                <a
                    href="https://www.paypal.com/de"
                    target="_blank"
                >https://www.paypal.com/de</a>; Datenschutzerklärung:
                <a
        ...
        <ul class="m-elements">
            <li>
                ...
                besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten),
                Meta-/Kommunikationsdaten (z.B. Geräte-Informationen, IP-Adressen),
                Inhaltsdaten (z.B. Texteingaben, Fotografien, Videos), Bestandsdaten
            ...
            <li>
                ...
                Nutzerprofilen), Vertragliche Leistungen und Service,
        ...
        <ul class="m-elements">
            <li>
                <strong>TikTok-Plugins und -Inhalte:</strong> TikTok-Plugins und
                -Inhalte - Hierzu können z.B. Inhalte wie Bilder, Videos oder Texte
                und Schaltflächen gehören. Dienstanbieter: musical.ly Inc., 10351
                Santa Monica Blvd #310, Los Angeles, CA 90025 USA; Website:
                <a
                    href="https://www.tiktok.com"
                    target="_blank"
                >https://www.tiktok.com</a>; Datenschutzerklärung:
                <a
            ...
            <li>
                ...
                <a
                    ...
                    target="_blank"
                >https://policies.google.com/privacy</a>; Widerspruchsmöglichkeit (Opt-Out): Opt-Out-Plugin:
                <a
                    href="https://tools.google.com/dlpage/gaoptout?hl=de"
                    target="_blank"
                >https://tools.google.com/dlpage/gaoptout?hl=de</a>, Einstellungen für die Darstellung von Werbeeinblendungen:
                <a
        ...
        <ul class="glossary">
            <li>
                ...
                jeweils verlinkenden Webseiten können eine Provision erhalten, wenn
                Nutzer diesen sogenannten Affiliate-Links folgen und anschließend
                die Angebote wahrnehmen (z.B. Waren kaufen oder Dienstleistungen in
                ...
                interessieren, diese anschließend auf die Veranlassung der
                Affiliate-Links wahrnehmen. Daher ist es für die Funktionsfähigkeit
                von Affiliate-Links erforderlich, dass sie um bestimmte Werte
                ergänzt werden, die ein Bestandteil des Links werden oder
                anderweitig, z.B. in einem Cookie, gespeichert werden. Zu den Werten
                gehören insbesondere die Ausgangswebseite (Referrer), der Zeitpunkt,
            ...
            <li>
                <strong>Interessenbasiertes und verhaltensbezogenes Marketing:</strong>
        ...
        <a
            ...
            class="seal text-muted-foreground text-sm"
...
useSeoMeta({
    title: "Imprint",
    description: "Our Imprint page provides essential information about SmashMC, including legal details, contact information, and data protection practices. Learn more about our Minecraft network and how we handle your data responsibly.",
})
</script>
