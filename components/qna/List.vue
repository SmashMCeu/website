            ...
            <template v-for="item in accordionItems" :key="item.value" >
                ...
                >
                    <AccordionHeader class="flex">
                        <AccordionTrigger class="rounded data-[state=open]:text-primary text-textColorLight hover:bg-backgroundColorLight/75 transition-colors duration-300 flex flex-1 cursor-pointer items-center gap-2 bg-backgroundColorLight py-5 px-5 text-[15px] leading-none outline-none group">
                            <Icon
